...
export function MenuDropdown({
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        className="rounded-md px-2.5 py-1.5 text-sm font-medium text-slate-700 transition hover:bg-slate-100 hover:text-slate-950"
      ...
      {open ? (
        <div className="absolute left-0 top-full z-30 mt-2 min-w-52 rounded-xl border border-slate-200 bg-white p-1.5 shadow-xl">
          {items.map((item) => (
            <button
